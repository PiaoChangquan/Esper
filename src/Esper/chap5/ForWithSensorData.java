...
public class ForWithSensorData {
	public static void main(String[] arges) {
		...
		// Epl For
		// Syntax: for grouped_delivery (group_expression [, group_expression]
		// [,...])

		// String ForEPL = "select * from Sensor.win:length_batch(5) "
		// + "for grouped_delivery(id)";
		// EPStatement stateForEPL = admin.createEPL(ForEPL);
		// stateForEPL.addListener(new GeneralListener());

		// Epl for discrete_delivery
		// Syntax: for discrete_delivery
		
		String ForEPL = "select * from Sensor.win:length_batch(5) " + "for discrete_delivery";
		EPStatement stateForEPL = admin.createEPL(ForEPL);
		stateForEPL.addListener(new GeneralListener());
